...
import {
	StyledAddBookForm,
	StyledAddBookImage,
	StyledAddBookImageInput,
	StyledAddBookInputes,
	StyledAddBookTitle,
...
export const AddBook = () => {
	...
	async function handleFormSubmit(evt) {
		...
		data.append('page', pagesRef.current.value);
		...
		data.append('description', bioRef.current.value);
		...
		<StyledAddBookWrapper>
			<StyledAddBookImage
				...
				<StyledInputWrapper
					...
					<StyledAddBookImageInput type='file' id='download' />
				</StyledInputWrapper>
			</StyledAddBookImage>
			<StyledAddBookInputes
				style={
				...
				<StyledAddBookTitle
					...
					{lang('addBook.addBookTitle')}
				</StyledAddBookTitle>
				<StyledAddBookForm onSubmit={handleFormSubmit}>
					<Stack spacing={2}>
						<TextField
							inputRef={titleRef}
							type='text'
							label={lang('addBook.title')}
							InputProps={
								mode
									? { style: { color: '#FFF' } }
									: { style: { color: '#000' } }
